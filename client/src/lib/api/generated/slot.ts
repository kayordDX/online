...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSlotGetContractsQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof slotGetContracts>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
