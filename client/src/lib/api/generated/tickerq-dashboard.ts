...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getOptions>>> = ({ signal }) =>
		getOptions({ signal, ...requestOptions });
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getTimeTickers>>> = ({ signal }) =>
		getTimeTickers({ signal, ...requestOptions });
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getTimeTickersPaginated>>> = ({
		signal,
	}) => getTimeTickersPaginated(params, { signal, ...requestOptions });
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getTimeTickersGraphDataRange>>> = ({
		signal,
	}) => getTimeTickersGraphDataRange(params, { signal, ...requestOptions });
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getTimeTickersGraphData>>> = ({
		signal,
	}) => getTimeTickersGraphData({ signal, ...requestOptions });
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getCronTickers>>> = ({ signal }) =>
		getCronTickers({ signal, ...requestOptions });
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getCronTickersPaginated>>> = ({
		signal,
	}) => getCronTickersPaginated(params, { signal, ...requestOptions });
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getCronTickersGraphDataRange>>> = ({
		signal,
	}) => getCronTickersGraphDataRange(params, { signal, ...requestOptions });
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getCronTickersByIdGraphDataRange>>> = ({
		signal,
	}) => getCronTickersByIdGraphDataRange(params, { signal, ...requestOptions });
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getCronTickersGraphData>>> = ({
		signal,
	}) => getCronTickersGraphData({ signal, ...requestOptions });
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getCronTickerOccurrences>>> = ({
		signal,
	}) => getCronTickerOccurrences(cronTickerId, { signal, ...requestOptions });
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getCronTickerOccurrencesPaginated>>> = ({
		signal,
	}) => getCronTickerOccurrencesPaginated(cronTickerId, params, { signal, ...requestOptions });
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getCronTickerOccurrencesGraphData>>> = ({
		signal,
	}) => getCronTickerOccurrencesGraphData(cronTickerId, { signal, ...requestOptions });
...
export const getToggleCronTickerUrl = (params: ToggleCronTickerParams) => {
	const normalizedParams = new URLSearchParams();
	...
	return stringifiedParams.length > 0
		? `/api/cron-ticker/toggle?${stringifiedParams}`
		: `/api/cron-ticker/toggle`;
};

export const toggleCronTicker = async (
	params: ToggleCronTickerParams,
	options?: RequestInit
): Promise<void> => {
	return customInstance<void>(getToggleCronTickerUrl(params), {
		...options,
		method: "PUT",
	});
};

export const getToggleCronTickerMutationOptions = <
	TError = ErrorType<unknown>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
		Awaited<ReturnType<typeof toggleCronTicker>>,
		TError,
		{ params: ToggleCronTickerParams },
		TContext
	>;
	...
	TContext
> => {
	const mutationKey = ["toggleCronTicker"];
	const { mutation: mutationOptions, request: requestOptions } = options
		? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
			? options
			: { ...options, mutation: { ...options.mutation, mutationKey } }
	...
	> = (props) => {
		...
		return toggleCronTicker(params, requestOptions);
	};

	return { mutationFn, ...mutationOptions };
};

export type ToggleCronTickerMutationResult = NonNullable<
	Awaited<ReturnType<typeof toggleCronTicker>>
>;

export type ToggleCronTickerMutationError = ErrorType<unknown>;

export const createToggleCronTicker = <TError = ErrorType<unknown>, TContext = unknown>(
	options?: () => {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof toggleCronTicker>>,
			TError,
...
> => {
	return createMutation(
		() => ({ ...getToggleCronTickerMutationOptions(options?.()) }),
		queryClient
	);
};
...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getTickerRequest>>> = ({ signal }) =>
		getTickerRequest(params, { signal, ...requestOptions });
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getTickerFunctions>>> = ({ signal }) =>
		getTickerFunctions({ signal, ...requestOptions });
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getNextTicker>>> = ({ signal }) =>
		getNextTicker({ signal, ...requestOptions });
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getTickerHostStatus>>> = ({ signal }) =>
		getTickerHostStatus({ signal, ...requestOptions });
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getLastWeekJobStatus>>> = ({ signal }) =>
		getLastWeekJobStatus({ signal, ...requestOptions });
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getJobStatuses>>> = ({ signal }) =>
		getJobStatuses({ signal, ...requestOptions });
...
>(options?: {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getMachineJobs>>> = ({ signal }) =>
		getMachineJobs({ signal, ...requestOptions });
